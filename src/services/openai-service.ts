...
**重要要求**: 请在总结最后添加"参考帖子"部分，使用HTML链接格式以支持悬停预览：

## 📚 参考帖子
请使用HTML格式的链接，包含data属性以支持悬停预览，例如：
1. <a href="链接地址" class="post-reference" data-preview="帖子内容预览" data-author="作者" data-title="帖子标题">帖子标题</a>
2. <a href="链接地址" class="post-reference" data-preview="帖子内容预览" data-author="作者" data-title="帖子标题">帖子标题</a>
...

请用清晰、有条理的中文回答，使用合适的标题格式，为对"${content.query}"话题感兴趣的小红书用户提供有用信息。

重点提供可操作的见解和有价值的信息，并确保使用正确的HTML链接格式以支持悬停预览功能。`;
  }
} 